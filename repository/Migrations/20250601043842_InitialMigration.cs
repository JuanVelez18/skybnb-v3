        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsoCode = table.Column<string>(type: "varchar(2)", unicode: false, maxLength: 2, nullable: false),
                    PhoneCode = table.Column<string>(type: "varchar(5)", unicode: false, maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolesPermissions", x => new { x.RolesId, x.PermissionsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BasePricePerNight = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Represent the system administrator", "Admin" },
                    { 2, "Represent the property owner", "Host" },
                    { 3, "Represent the property guest", "Guest" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Auditories_Timestamp",
                table: "Auditories",
                column: "Timestamp");

            migrationBuilder.CreateIndex(
                name: "IX_Auditories_UserId_Timestamp",
                table: "Auditories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolesPermissions_PermissionsId",
                table: "RolesPermissions",
